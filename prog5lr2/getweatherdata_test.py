...
key = 'fc672cd4ccc27b3f76ec7a1c76a7d399'
...
def test_countries(city, api_key, expected_country):
    ...
    assert json.loads(getweatherdata.get_weather_data(city, api_key=key)).get('sys',
...
def test_utc_time(city, api_key, expected_time):
    import json
    import datetime
    json_response = json.loads(getweatherdata.get_weather_data(city, api_key=key)).get('timezone',
                                                                                       'NoValue')
